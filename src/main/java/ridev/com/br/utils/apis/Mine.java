...
public final class Mine {
    ...
    /**
     * Cria uma jaula num local do mapa com os blocos escolido
     *
...
//				}
     ...
     * @return Som
     */
    public static ridev.com.br.utils.other.Sound getSound(Object object) {
        String str = object.toString().replace("_", "").trim();
        for (ridev.com.br.utils.other.Sound sound : ridev.com.br.utils.other.Sound.values()) {
    ...
    public static List<String> getSounds(String argument) {
        ...
        for (ridev.com.br.utils.other.Sound enchant : Sound.values()) {
