package ridev.com.br.utils.apis;
...
//            return CraftItemStack.asBukkitCopy(nmsIS);
    ...
    public static void sendNameTag(Player player, String prefix, String suffix, int order) {
        ...
        try {
            ...
            Extra.setValue(packet, "g", Collections.singletonList(player.getName()));
            Extra.setValue(packet, "h", 0);
            Extra.setValue(packet, "i", 1);
    ...
    public static void sendTitle(Player p, int fadeIn, int stay, int fadeOut, String title, String sub) {
