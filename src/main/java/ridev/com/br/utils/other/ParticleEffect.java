...
public enum ParticleEffect {
    ...
    BLOCK_CRACK("BLOCK_CRACK", 37, "blockcrack", 37, -1, ParticleProperty.DIRECTIONAL, ParticleProperty.REQUIRES_DATA),
    ...
    ParticleEffect(final String s, final int n, final String name, final int id, final int requiredVersion, final ParticleProperty... properties) {
        this.name = name;
        this.id = id;
    ...
    public enum ParticleProperty {
        ...
        ParticleProperty(final String s, final int n) {
        }
    }
